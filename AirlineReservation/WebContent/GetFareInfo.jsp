...
<head>
  ...
  function checkMe()
  {
	  if(document.getElementById('flightNum').value=='')
		{
    ...
    <!--/.SLIDESHOW END-->
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <form action="/AirlineReservation/ActionServlet" method="post" onsubmit="return checkMe()">
                 <input type="hidden" name="type" value="getfare">
                 <div class="row">
                    <div class="col-md-12">
                     <h2>Find Fare Information</h2>  
                        ...
                        <input type="submit" name="submit" value="Show Fare" class="btn btn-success ">

        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <form action="/AirlineReservation/ActionServlet" method="post" onsubmit="return checkMe()">
                 <input type="hidden" name="type" value="getpassengerlist">
                 <div class="row">
                    <div class="col-md-12">
                     <h2>Find List of Passengers</h2>  
                        ...
                        <input type="submit" name="submit" value="Show Passengers" class="btn btn-success ">
